...
var machLimit = prompt("You have been commissioned to design a 3D scene for a short" +
" animated film. You are very capable of this job, but your freeloader friend has borrowed" +
" your most powerful machine and kept it much longer than you agreed they could. What is" +
" the highest number of polygons you can have in a character for it to work effectively in the scene.");
...
var machRtrn = prompt("Has your freeloading friend showed up with your machine yet? Yes or No");

if(modelPoly <= machLimit || machRtrn === Yes){
